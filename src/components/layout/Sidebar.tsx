...
// Сол жақ мәзір — UI blueprint бойынша.
// Логотип жоғарыда, навигация, белсенді элемент жанып тұрады, төменде апталық мақсат.
...
import {
  ...
  Dumbbell, Gamepad2, GraduationCap, BarChart3, Trophy, Settings,
} from "lucide-react";
...
interface NavItem {
  ...
  key: TransKey;
  path: string;
  color: string; // белсенді жану түсі
}
